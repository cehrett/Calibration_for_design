...
%
These imperfections, uncertainties and errors cause uncertainty in the solution to a given design problem. 
...
%
These materials are themselves developed without a specific end-use in mind, and as a result the design of the system is constrained by the initial material selection.
%
