...
A separate means of incorporating model shortcoming would be to treat it as model discrepancy $\delta(\cdot)$ rather than as observation variance. Ordinarily, $\delta(\cdot)$ is itself modeled as a mean-zero GP; see (\ref{gaussian_processes}) above. 
