...
%
When one lacks the prior knowledge necessary to select target outcomes near the Pareto front and an accurate prior for $\lambda_\delta$, one option is a ``preliminary round'' of CTO to estimate the Pareto front.
%
...
2.&  Use MCMC to draw from $\boldsymbol\theta|\mathbf y$ and thereby from the posterior predictive distribution.\\
