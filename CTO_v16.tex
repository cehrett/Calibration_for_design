...
We used \texttt{fmincon()} in \texttt{MATLAB} \cite{MATLAB2017} %\cite{Cauchy1847} 
...
%
During the burn-in period, the covariances of the proposal distributions were periodically adjusted to be the sample covariance of the preceding draws scaled for an optimal acceptance rate of around $23\%$ for the multivariate input space \cite{Roberts1997,Gelman2013}. %HERE ref
%
