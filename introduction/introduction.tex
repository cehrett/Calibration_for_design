...
%	Outline:
%	1. Introduction to computer model calibration
...
%	2. Lit review of computer model calibration
%		1. Situate Bayesian calibration in wider context
%	3. Comparison of calibration and design 
%	4. Introduction to model-assisted design
%		1. Broad lit review of optimization
%		2. Place Bayesian optimization in context of other optimization methods
%	5. Lit review for model-assisted design 
%		1. Lit review for Bayesian optimizationDAte
%	6. Introduction to Gaussian process meta-models
%	7. Lit review for GP meta-models 
%	8. Elucidation of the Kennedy-O'Hagan framework for calibration 
%	9. Introduction to Wind Turbine System 
%	10. Introduction to Dynamic Vibration System 
%	11. Description of the two chapters 
