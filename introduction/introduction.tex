...
We wed the material design with the goals of the engineering design application, so that our search space is not limited to pre-existing or previously studied composites.
