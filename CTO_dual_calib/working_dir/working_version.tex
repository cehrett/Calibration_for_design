...
\begin{figure}
	\centering
	\includegraphics[height=1.75in]{FIG_dvs_illustration}
	\includegraphics[height=1.75in]{DSC_5206_crop}
	\captionsetup{width=.85\linewidth}
...
%
The simulator is implemented in the commercial finite element software ABAQUS \cite{Abaqus2012} TODO VERIFY CORRECT VERSION.
%
...
%
The convergence of the resulting MCMC chains is assessed both visually and using the Gelman-Rubin statistic ($\approx1.01$ and $1.001$ for calibration and design respectively); \cite{Gelman1992a}, \cite{Gelman1992a}).
%
