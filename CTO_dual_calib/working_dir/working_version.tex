...
\begin{table*}
	...
	\begin{tabular}{c|ccc}
		...
		\else
			Variable unit&Mass (kg)& Gain factor (Ns/m)&Overall damping ratio\footnotemark (-)\\
		\fi
		\hline
		1&1.1493&0&0.0523\\
		2&0.9653&0&0.0481\\
	...
	\label{table:exp}
\end{table*}
\footnotetext{``Overall damping ratio'' refers to the combination of active and passive damping.}
%
