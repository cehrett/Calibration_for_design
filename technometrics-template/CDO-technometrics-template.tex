...
When a target cannot be selected (for example, because priorities regarding cost/performance trade-offs have not yet been settled), design can be carried out using each point in a grid over the region of plausible target values.
%
